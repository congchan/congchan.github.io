...
- **Format Rewards**: Enforce structural consistency by requiring the model to place reasoning processes between specific tags (e.g., <|FunctionCallBegin|> and <|FunctionCallEnd|>).
